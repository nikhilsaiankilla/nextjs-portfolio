        ...
        <section id="experience" className="my-10" aria-label="Experience">
            ...
            <ul className="w-full flex flex-col gap-7">
                <li className="flex flex-col border-l-[1px] border-[#363636] pl-4 space-y-3">
                    <Link href='https://hussainiwelfareassociation.in' target="_blank" className="text-base flex items-center justify-between gap-1 group font-semibold text-light-accent">
                        Hussaini Welfare Association
                        <div className="flex items-center gap-1 text-sm dark:text-light-primary text-dark-primary font-normal">
                            Visit
                            <ArrowRight size={18} className="rotate-0 transition-all duration-100 ease-in-out group-hover:-rotate-45" />
                        </div>
                    </Link>
                ...
                <li className="flex flex-col border-l-[1px] border-[#363636] pl-4 space-y-3">
                    <Link href='https://purpledry.in' target="_blank" className="text-base flex items-center justify-between gap-1 group font-semibold text-light-accent">
                        PurpleDry
